          ...
          <div className="hero-image flex-custom-center relative h-[90vh] w-[100vw]">
            ...
            <div className="flex-custom-center w-full h-full z-20">
              <div className="flex-custom-col items-center justify-center hero-flex-gap h-full">
                ...
                <div
                  className={`btn md:w-[12rem] w-[80%] btn-svg h-[3rem] border-[0.5px] border-white bg-transparent text-white hover:bg-white hover:text-black`}
                >
                  <div className="btn-content gap-3">
                    <a
                      href="https://portfoliobysidd.netlify.app/"
                      class="px-6 py-2 bg-[#e88024] text-white font-semibold rounded-lg shadow-md hover:bg-[#cc6d1f] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#e88024] focus:ring-offset-2"
                      target="_blank"
                    ...
                    <div className="flex flex-col md:flex-row md:justify-between items-center text-18 md:text-5">
                      <div className="flex flex-col md:flex-row md:mb-0">
                        <div className="mb-8 md:mr-5">
                          ©
                          <span
                            className="mr-1.5 ml-0.5 uppercase"
                        ...
                        <ul className="space-y-3 md:flex md:space-x-5 md:space-y-0">
                          ...
                          <li>
                            <a href="/anti-slavery-policy.html">
                              Anti-Slavery Policy
                            </a>
                          </li>
                        </ul>
